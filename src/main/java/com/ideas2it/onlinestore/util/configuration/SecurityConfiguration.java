	...
	public SecurityFilterChain filterChain(HttpSecurity httpSecurity) throws Exception {
		...
		httpSecurity.csrf().disable().authorizeRequests()		    
		    ...
		    .antMatchers(HttpMethod.GET, Constant.API_V1_WISHLIST).hasAuthority(Constant.CUSTOMER)
				...
				.antMatchers(HttpMethod.POST, Constant.API_V1_CATEGORY).hasAnyAuthority(Constant.ADMIN)
				.antMatchers(HttpMethod.GET, Constant.API_V1_CATEGORY).hasAnyAuthority(Constant.CUSTOMER,  Constant.SELLER, Constant.ADMIN)
				.antMatchers(HttpMethod.GET, Constant.API_V1_CATEGORY_ALL).hasAnyAuthority(Constant.CUSTOMER, Constant.SELLER, Constant.ADMIN)
